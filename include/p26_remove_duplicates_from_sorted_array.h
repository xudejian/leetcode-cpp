#ifndef __P26_REMOVE_DUPLICATES_FROM_SORTED_ARRAY_H__
#define __P26_REMOVE_DUPLICATES_FROM_SORTED_ARRAY_H__

#include "header.h"

namespace leetcode {
namespace p26_remove_duplicates_from_sorted_array {
...
#endif  // __P26_REMOVE_DUPLICATES_FROM_SORTED_ARRAY_H__
